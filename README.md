...
[![PyPI version](https://badge.fury.io/py/lorem-gen.svg)](https://pypi.org/project/lorem-gen/)
...
```bash
pip install lorem-gen
```

## Quick Start

```python
from lorem_gen import gen
